...
//This class is dedicated to managing and granting the event handling related functions that an upgrade store needs
...
public class ShopUpgradeEventMethod : MonoBehaviour
{
    ...
    public ShopUpgradeEventMethod(ShopModel shopModel)
    {
